...
if __name__ == "__main__":
    ...
    parser.add_argument("--name_experiment", default="CBAM_ESR_9_extend_sp_ch_ce_detdiv_dda_224")
    parser.add_argument("--base_path_to_dataset", default="../FER_data/AffectNet_224")
